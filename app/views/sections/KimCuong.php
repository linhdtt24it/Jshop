<?php
// app/views/sections/KimCuong.php
// Đã sử dụng biến $productsKimCuong đã được truyền từ HomeController
$products = $productsKimCuong;
?>
...
.kimcuong-section { position: relative; overflow: hidden; }
...
document.addEventListener('DOMContentLoaded', function() {
  const container = document.querySelector('.kimcuong-section .product-slider-container');
  if (!container) return; 
