<?php
// app/views/sections/TrangSucNam.php
// Đã sử dụng biến $tsNam đã được truyền từ HomeController
$products = $tsNam; 
?>
...
.trangsucnam-section { position: relative; overflow: hidden; padding: 40px 0; }
...
document.addEventListener('DOMContentLoaded', function() {
  const container = document.querySelector('.trangsucnam-section .product-slider-container');
  if (!container) return; 
