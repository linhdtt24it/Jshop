...
.spkhac-section { position: relative; overflow: hidden; padding: 40px 0; }
...
document.addEventListener('DOMContentLoaded', function() {
  const container = document.querySelector('.spkhac-section .product-slider-container');
  if (!container) return; 
  ...
  const gap = 20; 
  const cloneCount = 2; // Clone count 2
