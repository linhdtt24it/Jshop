<?php
// app/views/sections/Ngoc.php
// Đã sử dụng biến $productsNgoc đã được truyền từ HomeController
$products = $productsNgoc;
?>
...
.ngoc-section { position: relative; overflow: hidden; padding: 40px 0; }
...
document.addEventListener('DOMContentLoaded', function() {
  const container = document.querySelector('.ngoc-section .product-slider-container');
  if (!container) return; 
