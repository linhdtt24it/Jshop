<?php
// app/views/sections/SanPhamYeuThich.php
// Đã sử dụng biến $productsYeuThich đã được truyền từ HomeController
$products = $productsYeuThich; 
?>
...
.new-products-section { position: relative; overflow: hidden; padding: 40px 0; }
...
@media (max-width: 768px) { .product-card { min-width: 200px; } }
@media (max-width: 480px) { .product-card { min-width: 150px; } }
</style>

<script>
document.addEventListener('DOMContentLoaded', function() {
  const container = document.querySelector('.new-products-section .product-slider-container');
  if (!container) return; 
