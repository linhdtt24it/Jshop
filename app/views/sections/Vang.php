<?php
// app/views/sections/Vang.php
// Đã sử dụng biến $productsVang đã được truyền từ HomeController
$products = $productsVang;
?>
...
.vang-section { position: relative; overflow: hidden; padding: 40px 0; }
...
document.addEventListener('DOMContentLoaded', function() {
  const container = document.querySelector('.vang-section .product-slider-container');
  if (!container) return; 
